...
TurtleLaser::TurtleLaser() : Node("turtle_laser")
{
    laser_scan_sub_ = this->create_subscription<sensor_msgs::msg::LaserScan>(
        "/scan", 10, std::bind(&TurtleLaser::remapLaserReading, this, std::placeholders::_1));
...
void TurtleLaser::remapLaserReading(const sensor_msgs::msg::LaserScan::SharedPtr scan)
{   
...
int main(int argc, char *argv[])
{
    ...
    rclcpp::spin(std::make_shared<TurtleLaser>());
    rclcpp::shutdown();
    return 0;
}
